...
export const fittingCompatibility = {
    ...
    Ball_Valve_TOYO: {
        materials: [
            ...
            'ステンレス鋼 (レバー)', 'ステンレス鋼 (ギア)', 'ステンレス鋼 (アクチェータ)', 'ステンレス鋼 (ねじ)',
        ],

        jisMap: {
            'ダクタイル鋳鉄 (レバー)': ['B2220_DBF'], 'ダクタイル鋳鉄 (ギア)': ['B2220_DBFG'],
            'ステンレス鋼 (レバー)': ['B2220_UBF', 'ASME B16.15'], 'ステンレス鋼 (ギア)': ['B2220_UBFG'], 
            'ステンレス鋼 (アクチェータ)': ['B2220_A'], 'ステンレス鋼 (ねじ)': ['B0203_U'],
        },
