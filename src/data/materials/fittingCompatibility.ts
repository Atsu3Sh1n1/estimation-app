...
export const fittingCompatibility = {
    ...
    Ball_Valve_TOYO: {
        materials: [
            ...
            'ステンレス鋼 (レバー式)', 'ステンレス鋼 (アクチェータ式)', 'ステンレス鋼 (ねじ込み形)',
        ],

        jisMap: {
            'ダクタイル鋳鉄 (レバー式)': ['DBF-N-L'], 'ダクタイル鋳鉄 (ギア式)': ['DBF-N-G'],
            'ステンレス鋼 (レバー式)': ['B2220_UBF', 'ASME B16.15'], 
            'ステンレス鋼 (アクチェータ式)': ['A10-UBF'], 
            'ステンレス鋼 (ねじ込み形)': ['B0203_U'],
        },
