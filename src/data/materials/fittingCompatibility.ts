...
export const fittingCompatibility = {
    ...
    BL_flat_flange: {
        ...
        jisMap: {
            ...
            金24K: ['B2220_FFBL',], 銀Ag: ['B2220_FFBL',], 銅Cu: ['B2220_FFBL',], プラチナ: ['B2220_FFBL'], チタン: ['B2220_FFBL',], アルミ: ['B2220_FFBL',], 鋳鉄: ['B2220_FFBL',], 塩ビPVC: [], PEポリエチレン: ['B2220_FFBL',], ダイヤモンド: ['B2220_FFBL',], タングステン: ['B2220_FFBL',],
        },
    },
